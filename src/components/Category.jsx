...
const Category = (props)=>{
 ...
 <button value="food" onClick={handleClick} className="btn btn-secondary publicar-btn" >Food</button>
<button value="salary" onClick={handleClick} className="btn btn-secondary publicar-btn" >Salario</button>
<button value="cleanning" onClick={handleClick} className="btn btn-secondary publicar-btn" >Cleanning</button>
<button value="clothes" onClick={handleClick} className="btn btn-secondary publicar-btn" >Clothes</button>
<button value="other" onClick={handleClick} className="btn btn-secondary publicar-btn" >Other</button>
</div>
